...
rad=st.sidebar.radio("Navigation",["Summary","Educational Background","Skills","Data Science","Statement of Purpose"])
...
""")
  ...
  - Acquired hands-on experience in Data Analysis, Data Visualization, Machine Learning, Natural Language Processing and Deep Learning through completion of several projects as part of the program, setting a solid foundation in machine learning knowledge.
  """)
  ...
  *Aggregate Percentage* - `87%`
  ...
  txt('Natural Language Processing' ,'NLTK')
  txt('Deep Learning' ,'Tensorflow')
...
Below are the projects I completed while learning Data Science and Machine Learning. Before delving into Data Science, it was crucial to have a solid understanding of basic Python programming. As a milestone in my learning journey. These projects helped me to gain hands-on experience in solving real-world problems using data and algorithms. The following are the Data Science and Machine Learning projects I worked on, each providing me with a unique challenge and opportunity to expand my skillset in these fields.
  ...
  txt1('22','Stock-Market-Prediction-Forecasting','This is a Stock Market Prediction & Forecasting model that uses Long Short-Term Memory (LSTM) neural network to predict the future price of Apple (AAPL) stock. The model takes in a historical dataset of AAPL stock prices and outputs a forecast of future prices.',"https://github.com/Amadhuna/Stock-Market-Prediction-Forecasting")
  txt1('23','Cat-Dog-Deep-Learning-Image-Classification','This is a deep learning image classification model that uses a convolutional neural network (CNN) to classify images of cats and dogs. The model takes in an input image of a cat or a dog and outputs a binary classification of either "cat" or "dog".',"https://github.com/Amadhuna/Cat-Dog-Deep-Learning-Image-Classification-")
  txt1('24','Brain-Tumor-Image-Classification','This is an image classification model that uses machine learning to predict the presence of a brain tumor in medical images such as MRI or CT scans. The model takes in an input image of the brain and produces a binary output indicating the presence or absence of a brain tumor.',"https://github.com/Amadhuna/Brain-Tumor-Image--Classification")
  txt1('25','Fake-News-Classifier-using-RNN','This repository contains a fake news classifier created using deep learning LSTM. The model was trained on a large dataset of news articles, some of which were labeled as "fake" and some of which were labeled as "real"',"https://github.com/Amadhuna/Fake-News-Classifier-using-RNN")
...
if rad=="Statement of Purpose":
  ...
  st.markdown("""I am a highly motivated and technically proficient data science fresher seeking to join a dynamic organization where I can apply my skills and knowledge. With a background in aeronautical engineering and a two-year break to explore my interests and goals, I am now focused on pursuing a career in data science and AI.\n
  ...
  I am passionate about data science and eager to learn and explore new applications of the field. I am excited to join a team that values creativity, innovation, and critical thinking. \n
  I am a highly adaptable individual and a quick learner, and am confident that my skills and experience make me a strong candidate for any data science or AI-related role.\n
